...
class Client:
	def __init__(self):
		self.batchSize = 500
#		self.serverUrl = "https://na7-blitz04.soma.salesforce.com/services/Soap/u/37.0"
		self.serverUrl = "https://na73.salesforce.com/services/Soap/u/40.0"
		self.__conn = None
		self.timeout = 15
	...
	def login(self, username, password, serverUrl = None):
		if  serverUrl == None:
			serverUrl = self.serverUrl		               
		lr = LoginRequest(serverUrl, username, password).post()
...
class SoapEnvelope:
	def __init__(self, serverUrl, operationName, clientId="SfdcInternalQA/"):
